...
//   const newTask = { description, completed: false, index: tasks.length };
//   tasks.push(newTask);
//   saveTasks();
// }
...
//     const todo = document.querySelector('#add-list').value;
//     addTask(todo);
...
function editTask(index, newDescription) {
  console.log(`Updating task at index ${index} with new description: ${newDescription}`);
  tasks[index].description = newDescription;
